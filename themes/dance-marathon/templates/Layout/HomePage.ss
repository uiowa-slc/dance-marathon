	...
	<div class="container">
		...
		<div class="clearfix steps">
			<div class="step step1">
				...
				<a href="#" class="btn">Create an account <span class="icon-arrow-right"></span></a>
			</div>
			<div class="step step2">
				...
				<a href="#" class="btn">How to fundraise <span class="icon-arrow-right"></span></a>
			</div>
			<div class="step step3">
				...
				<a href="#" class="btn">Dancer stories <span class="icon-arrow-right"></span></a>
			</div>
		</div>
	</div>
</section>