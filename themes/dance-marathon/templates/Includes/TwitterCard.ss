...
<meta name="twitter:image" content="{$absoluteBaseURL}{$ThemeDir}/dist/images/og-stream2.jpg">
<% else %>
<meta name="twitter:image" content="{$absoluteBaseURL}{$ThemeDir}/dist/images/opengraph-default.jpg">
<% end_if %>
